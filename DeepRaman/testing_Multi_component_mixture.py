...
if __name__ == '__main__':
    ...
    #spectrum_mix = spectrum[13:,:] 
    spectrum_mix = spectrum
    ...
    plt.figure()
    plt.plot(spectrum_pure.T)
    plt.plot(spectrum_pure[1],'r')
    plt.plot(spectrum_pure[8],'k')   
    X = np.zeros((spectrum_mix_sc.shape[0]*spectrum_pure_sc.shape[0],2,1381,1))
    ...
    for cc in range(spectrum_mix.shape[0]):
        ...
        print('The',cc, 'th spectra may contain:',coms)
